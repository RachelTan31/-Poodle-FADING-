# code adapted from https://github.com/MunchkinChen/FADING
...
class DreamBoothDatasetAge(Dataset):
    """
    return instance (img, token of 'photo of a xx month old poodle')
    and (img, token of 'photo of a poodle')
    """
    def __init__(
        self,
        instance_data_root,
        ...
        tokenizer,
        instance_prompt="photo of a poodle",
        size=512,
        center_crop=False,
        ):
        ...
        self.age_labels = np.load(instance_age_path, allow_pickle=True)
    ...
    def __getitem__(self, index):
        ...
        example["instance_prompt_ids"] = self.tokenizer( # token(photo of a poodle)
        ...
        instance_age_prompt = self.instance_prompt.replace(" a ", f" a {instance_image_age} month old ")

        example["instance_age_prompt"] = instance_age_prompt
        example["instance_age_prompt_ids"] = self.tokenizer( # token(photo of a xx month old poodle)
            instance_age_prompt,
            truncation=True,
            padding="max_length",
            max_length=self.tokenizer.model_max_length,
